...
const GROUPS_DATA: Record<string, GroupDetail> = {
  "morning-musume": {
    ...
    snsLinks: [
      ...
      {
        platform: "twitter",
        url: "https://x.com/MorningMusumeMg",
      ...
      {
        platform: "tiktok",
        url: "https://www.tiktok.com/@morningmusume_uf",
        label: "@morningmusume_uf",
      },
    ],
  },
  angerme: {
    ...
    snsLinks: [
      ...
      {
        platform: "twitter",
        url: "https://x.com/angerme_upfront",
        label: "@angerme_upfront",
      },
      {
        platform: "youtube",
        url: "https://www.youtube.com/@angerme",
        label: "YouTube公式",
      },
      {
        platform: "tiktok",
        url: "https://www.tiktok.com/@angerme_uf",
        label: "@angerme_uf",
      },
    ],
  },
  "juice-juice": {
    ...
    snsLinks: [
      ...
      {
        platform: "twitter",
        url: "https://x.com/JuiceJuice_uf",
        label: "@JuiceJuice_uf",
      },
      {
        platform: "youtube",
        url: "https://www.youtube.com/@juicejuice",
        label: "YouTube公式",
      },
      {
        platform: "instagram",
        url: "https://www.instagram.com/juice_juice_official/",
        label: "@juice_juice_official",
      },
      {
        platform: "tiktok",
        url: "https://www.tiktok.com/@juicejuice_uf",
        label: "@juicejuice_uf",
      },
    ],
  },
  "ocha-norma": {
    ...
    snsLinks: [
      ...
      {
        platform: "twitter",
        url: "https://x.com/ocha_norma",
        label: "@ocha_norma",
      },
      {
        platform: "youtube",
        url: "https://www.youtube.com/@ochanorma",
        label: "YouTube公式",
      },
      {
        platform: "instagram",
        url: "https://www.instagram.com/ocha_norma_official/",
        label: "@ocha_norma_official",
      },
      {
        platform: "tiktok",
        url: "https://www.tiktok.com/@ocha_norma",
        label: "@ocha_norma",
      },
    ],
  },
  "tsubaki-factory": {
    ...
    snsLinks: [
      ...
      {
        platform: "instagram",
        url: "https://www.instagram.com/tsubakifactory_official/",
        label: "@tsubakifactory_official",
      },
      {
        platform: "tiktok",
        url: "https://www.tiktok.com/@tsubakifactory_uf",
        label: "@tsubakifactory_uf",
      },
    ],
  },
  beyooooonds: {
    ...
    snsLinks: [
      ...
      {
        platform: "instagram",
        url: "https://www.instagram.com/beyooooonds_official/",
        label: "@beyooooonds_official",
      },
      {
        platform: "tiktok",
        url: "https://www.tiktok.com/@beyooooonds_",
        label: "@beyooooonds_",
      },
    ],
  },
  "rosy-chronicle": {
    ...
    snsLinks: [
      ...
      {
        platform: "twitter",
        url: "https://x.com/Rosy_Chronicle",
        label: "@Rosy_Chronicle",
      },
      {
        platform: "youtube",
      ...
      {
        platform: "instagram",
        url: "https://www.instagram.com/rosy_chronicle_official/",
        label: "@rosy_chronicle_official",
      },
      {
        platform: "tiktok",
        url: "https://www.tiktok.com/@rosy_chronicle",
        label: "@rosy_chronicle",
      },
    ],
  },
